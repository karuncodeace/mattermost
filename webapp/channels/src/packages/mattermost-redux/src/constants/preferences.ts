...
const Preferences = {
    ...
    THEMES: {
        ...
        snackDark: {
            ...
            sidebarText: '#E6E8EE',
            sidebarUnreadText: '#FFFFFF',
            sidebarTextHoverBg: '#1B2340',
            sidebarTextActiveBorder: '#7C7CFF',
            sidebarTextActiveColor: '#FFFFFF',
            sidebarHeaderBg: '#0F172A',
            sidebarHeaderTextColor: '#FFFFFF',
            sidebarTeamBarBg: '#090F1D',
            onlineIndicator: '#2BD576',
            awayIndicator: '#FBBF24',
            dndIndicator: '#F43F5E',
            mentionBg: '#7C7CFF',
            mentionBj: '#7C7CFF',
            mentionColor: '#FFFFFF',
            centerChannelBg: '#020617',
            centerChannelColor: '#E6E8EE',
            newMessageSeparator: '#8B8CFF',
            linkColor: '#7AA2FF',
            buttonBg: '#7C7CFF',
            buttonColor: '#FFFFFF',
            errorTextColor: '#FB7185',
            mentionHighlightBg: '#1A1F4A',
            mentionHighlightLink: '#9AE6FF',
        ...
        snackLight: {
            ...
            sidebarBg: '#F9FAFB',
            sidebarText: '#334155',
            sidebarUnreadText: '#020617',
            sidebarTextHoverBg: '#EEF1FF',
            sidebarTextActiveBorder: '#5B5FFF',
            sidebarTextActiveColor: '#020617',
            sidebarHeaderBg: '#FFFFFF',
            sidebarHeaderTextColor: '#020617',
            sidebarTeamBarBg: '#EEF2FF',
            onlineIndicator: '#00D084',
            awayIndicator: '#FBBF24',
            dndIndicator: '#FF4D6D',
            mentionBg: '#5B5FFF',
            mentionBj: '#5B5FFF',
            mentionColor: '#FFFFFF',
            centerChannelBg: '#FFFFFF',
            centerChannelColor: '#020617',
            newMessageSeparator: '#A5B4FF',
            linkColor: '#3B5BFF',
            buttonBg: '#5B5FFF',
            buttonColor: '#FFFFFF',
            errorTextColor: '#FF3B5F',
            mentionHighlightBg: '#EEF1FF',
            mentionHighlightLink: '#3B82F6',
